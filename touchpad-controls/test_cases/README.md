...
This folder contains local HTML snapshots extracted from the pages dataset and the generated touchpad outputs.

## Structure
- `games/`: Source HTML files (one per game).
- `outputs/`: Embedded touchpad outputs generated from each game.
