(function (root, factory) {
    ...
    const chooseLayout = (bindings, preferredLayout, actionMeta = {}) => {
        ...
        if (hasMove) {
            ...
            const isLatch = moveMeta && moveMeta.activation === "latch";
            const mutuallyExclusive = isCardinal || isLatch;
            const requiresChord = moveMeta && moveMeta.simultaneous === true && !mutuallyExclusive;
